...
To support distributed rate limiting, we need a shared, low-latency, and scalable storage system to keep track of token
counts per user or IP. The system must allow fast reads/writes, TTL support, and atomic operations.
